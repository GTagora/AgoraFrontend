      ...
      <div className={styles.main}>
        <div className={styles.container}>
          ...
          <div className={styles.text}>
            <b>Kintsugi</b> &ndash;{' '}
            <i>
              The Japanese art of repairing broken pottery by meticulously
              joining pieces back together and filling cracks with lacquer
              dusted with powdered gold, silver, or platinum, thereby
              highlighting the flaws in the mended object. Also in extended use:
              an aesthetic or world view characterized by embracing imperfection
            ...
            <br />
            <br />
            <br />i am renewed in You
            <br />a beautiful creation now stands
            <br />
            ...
            <br />
            <br />
            in my imperfections, brokenness, weakness, does Your glory and mercy
            shine brightest
            <br />
