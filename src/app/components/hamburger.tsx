    ...
    <div className={styles.body}>
      <div className={styles.navbar} onClick={() => setOpen(!open)}>
        ...
        <div className={open ? styles.activebuttons : styles.buttons}>
          ...
          <Link href="/about">
            <div className={styles.indent}>Mission</div>
          </Link>
          <Link href="/about/staff">
            <div className={styles.indent}>Staff</div>
          </Link>

          <Link href="/archive">
            <div className={styles.label}>ARCHIVE</div>
          </Link>
          <Link href="/#latest-issue" className={styles.indent}>
            Latest Issue
          </Link>
          <Link href="/archive" className={styles.indent}>
            Past Issues
          </Link>
